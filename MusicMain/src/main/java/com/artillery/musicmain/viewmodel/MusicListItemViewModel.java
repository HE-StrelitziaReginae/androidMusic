...
public class MusicListItemViewModel extends MultiItemViewModel<MusicListViewModel> {
    ...
    public BindingCommand musicPlay = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            musicDialogFragment.setStyle(DialogFragment.STYLE_NORMAL, R.style.CustomFullDialog);
            musicDialogFragment.show(AppManager.getAppManager().currentFragment().requireFragmentManager(), toString());
        }
    });
}
